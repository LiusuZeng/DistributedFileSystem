...
//		}
    ...
    protected void initialize() throws TestFailed
    {
        ...
        try
        {
            server1 = new DeletionStorageServer("localhost", 9900, 9901);
            server1.start(registration_stub,
                          new Path[] {delete_file, dummy_file}, null);

            server2 = new DeletionStorageServer("localhost", 9902, 9903);
    ...
    private class DeletionStorageServer extends TestStorageServer
    {
        ...
        DeletionStorageServer(String ip, int port1, int port2)
        {
            super(DeletionTest.this, ip, port1, port2);
