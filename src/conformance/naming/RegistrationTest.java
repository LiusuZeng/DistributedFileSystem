...
public class RegistrationTest extends NamingTest
{
    ...
    {
        server1 = new TestStorageServer(this, "localhost", 8500, 8501);
        server2 = new TestStorageServer(this, "localhost", 8502, 8503);
        server3 = new TestStorageServer(this, "localhost", 8504, 8505);
        server4 = new TestStorageServer(this, "localhost", 8506, 8507);
