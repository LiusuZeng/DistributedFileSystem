...
public class ReplicationTest extends NamingTest
{
    ...
    {
    	System.out.println("This is the start of replication test!");
    	//
        int     access_counter;
        ...
        for(access_counter = 0; access_counter < ACCESS_COUNT; ++access_counter)
        {
            ...
            //
            System.out.println("&&& " + access_counter + " lock/unlock try completed...");
        }
    ...
    protected void initialize() throws TestFailed
    {
        ...
        try
        {
            hosting_server = new InvalidationStorageServer("localhost", 9600, 9601);
            hosting_stub =
                hosting_server.start(registration_stub,
                                     new Path[] {replicate_file}, null);

            mirror_server = new MirrorStorageServer("localhost", 9602, 9603);
    ...
    private class MirrorStorageServer extends InvalidationStorageServer
    {
    	...
    	public MirrorStorageServer()
    	{
    		super();
    	}
    	
    	public MirrorStorageServer(String ip, int port1, int port2)
    	{
    		super(ip, port1, port2);
    	}
    ...
    private class InvalidationStorageServer extends TestStorageServer
    {
        ...
        //
        InvalidationStorageServer(String ip, int port1, int port2)
        {
        	super(ReplicationTest.this, ip, port1, port2);
        }
