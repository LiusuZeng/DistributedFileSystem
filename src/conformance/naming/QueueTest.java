...
public class QueueTest extends NamingTest
{
    ...
    protected void perform()
    {
        ...
        startThread(false, 0, "R1");
        startThread(false, 0, "R2");
        ...
        // after.
        startThread(false, 3, "R3");
        startThread(false, 3, "R4");
     ...
     */
    private void startThread(boolean exclusive, int expect_lock_count, String name)
    {
        // Start the new thread.
    	System.out.println(name + " started!!!");
    	//
        new Thread(new QueuedLockUser(exclusive, expect_lock_count, name)).start();
    ...
    private class QueuedLockUser implements Runnable
    {
        ...
        protected QueuedLockUser(boolean exclusive, int expect_lock_count, String src_name)
        {
        ...
        public void run()
        {
            ...
            try
            {
            	System.out.println(this.name + "req lock begins!");
                service_stub.lock(root, exclusive);
                System.out.println(this.name + " gets the lock!");
            }
            catch(Throwable t)
            {
            ...
            try
            {
                ...
                System.out.println(this.name + "releases the lock!");
            }
            catch(Throwable t)
            {
            ...
            //
            System.out.println(this.name + " END OF STORY------->>>>>>>>>>");
        }
    }
}
